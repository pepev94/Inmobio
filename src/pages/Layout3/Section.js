          ...
          <Container>
            <Row className="justify-content-center">
              ...
              <div className="text-center">
                <h1 className="hero-3-title text-dark line-height-1_4">Tu primer Airbnb sin enganche</h1>
                <p className="text-muted mb-4 pb-3">Empieza a recibir ingresos pasivos desde el primer mes</p>
